...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2026 at 02:16 PM
...
(12, 2, 'માતાજી ની સાખી', 'uploads/categoryimage/1755772996.jpg', 1, '2025-08-21'),
...
INSERT INTO `certificates` (`id`, `title`, `image`, `isActive`, `created_on`) VALUES
(1, 'Best singer award', 'uploads/certificate/bce0f6006f1f3a38a21cb92177df6fbb.png', 1, '2026-02-19 10:35:29'),
(4, 'sujal ', 'uploads/certificate/b43b2cb0dd635d30ba88fb082836e438.png', 1, '2026-02-19 11:53:19'),
(6, 'fjiofoirmoifr', 'uploads/certificate/ce191c8808a1923474ad59c047b37928.png', 1, '2026-02-19 13:22:21');
...
INSERT INTO `suggestions` (`id`, `user_id`, `user_name`, `message`, `created_on`) VALUES
(1, 2, 'yug joshi', 'Very good app', '2026-02-19 12:40:11'),
(6, 2, 'yug joshi', 'best but UI is not better', '2026-02-20 09:00:22');
...
CREATE TABLE `users` (
  ...
  `role` int(11) NOT NULL COMMENT 'admin=1\r\nuser=0',
  `isActive` tinyint(4) NOT NULL DEFAULT 1,
  `created_on` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'yug joshi', '9904300073', '2892006', 1, 1, '0000-00-00'),
